...
class PortfolioGallery {
  constructor(selector) {
    ...
    this.images = [
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/bookworm.avif",
        "alt": "Bookworm project showcase",
        "width": 1080,
        "height": 608
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/bw-cover.avif",
        "alt": "Bookworm cover design",
        "width": 1080,
        "height": 608
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/atoms-3.avif",
        "alt": "Atoms design system part 3",
        "width": 1080,
        "height": 608
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/atoms-2.avif",
        "alt": "Atoms design system part 2",
        "width": 1080,
        "height": 608
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/atoms-1.avif",
        "alt": "Atoms design system part 1",
        "width": 1080,
        "height": 608
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/opt-2.webp",
        "alt": "Opt project showcase 2",
        "width": 7680,
        "height": 4320
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/opt-1.webp",
        "alt": "Opt project showcase 1",
        "width": 7680,
        "height": 4320
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/polarcam-1.avif",
        "alt": "Polarcam project showcase",
        "width": 1080,
        "height": 608
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/explrar-explorations-2025.avif",
        "alt": "Explrar explorations 2025",
        "width": 4096,
        "height": 2304
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/image-cards.avif",
        "alt": "Image cards design exploration",
        "width": 4096,
        "height": 2304
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/metal-cover.avif",
        "alt": "Metal cover design",
        "width": 1080,
        "height": 608
      },
      {
        "src": "https://res.cloudinary.com/barthkosi/image/upload/f_auto,q_auto/v1756359979/metal-logo.webp",
        "alt": "Metal logo design",
        "width": 1080,
        "height": 608
      }
    ];
  ...
  async render() {
    ...
    try {
      ...
      this.images.forEach((image, index) => {
        fragment.appendChild(this.createItem(image, index));
      });

      this.grid.replaceChildren(fragment);
    } catch (error) {
      console.error(error);
      this.grid.textContent = 'Portfolio images could not be loaded.';
    }
  }

  createItem(image, index) {
    const article = document.createElement('article');
    article.className = 'portfolio-item';

    const img = document.createElement('img');
    img.src = image.src;
    img.alt = image.alt || 'Portfolio project showcase';
    img.className = 'portfolio-image';
    img.width = image.width || 1920;
    img.height = image.height || 1080;
    img.decoding = 'async';
...
class AnimationController {
  ...
  init() {
    ...
    // 3. Start Observing
    this.items.forEach((item, index) => {
      if (index >= 2) observer.observe(item);
    });
  }
...
class PortfolioApp {
  ...
  async setup() {
    // 1. Render Portfolio Gallery
    this.gallery = new PortfolioGallery('[data-portfolio-grid]');
