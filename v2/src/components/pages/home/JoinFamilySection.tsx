    ...
    <section className="flex flex-col items-center px-4 md:px-8 py-12 gap-8 text-center">
      <div className="flex items-center justify-center gap-3">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="label-s text-[var(--content-primary)]">Barth Kosi</p>
        </div>
        <Image
      ...
      <div className="flex w-full max-w-[720px] flex-col items-center gap-3">
        ...
        <p className="body-l max-w-[720px] text-pretty text-[var(--content-secondary)]">
          From early-stage concepts to established brands, my work has helped
          projects find their voice and create emotional connections that have
          driven brand loyalty and meaningful engagement.
        </p>
      </div>
