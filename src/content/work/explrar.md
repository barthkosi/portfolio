...
coverImage: "https://res.cloudinary.com/barthkosi/image/upload/explrar-cover-blue.avif"
bannerImage: "https://res.cloudinary.com/barthkosi/image/upload/explrar-banner.avif"
...
![Before](https://res.cloudinary.com/barthkosi/image/upload/old-explrar.avif)
...
![Logo refresh before vs after](https://res.cloudinary.com/barthkosi/image/upload/explrar-logo-refresh.avif)
...
![8px radius vs 99px radius on the same button or card](https://res.cloudinary.com/barthkosi/image/upload/explrar-button-change.avif)
...
![Type comparison — Poppins vs Manrope/Inter on the same screen](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)
...
![Color comparison — yellow/blue version vs blue-only version, same screen](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)

Blue took the lead. Things started breathing.

![Before/after — full screen comparison, old design vs new](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)
...
![Screens with padding highlighted to show consistent spacing](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)
...
![Full design system spread — Figma screenshot showing all 40+ components laid out](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)
...
![Snippet of handoff documentation — spacing values, naming conventions, usage guidelines, multiple shots](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)
...
![Custom dropdown components](https://res.cloudinary.com/barthkosi/image/upload/explrar-custom-dropdown.avif)

### The Form

The centerpiece of the AI redesign was a single screen.

![Itinerary form screens](https://res.cloudinary.com/barthkosi/image/upload/explrar-itinerary-form.avif)
...
![Custom dropdown component in use](https://res.cloudinary.com/barthkosi/image/upload/explrar-date-picker.avif)
...
![](https://res.cloudinary.com/barthkosi/image/upload/explrar-trip-plan.avif)

![](https://res.cloudinary.com/barthkosi/image/upload/explrar-activities.avif)

![](https://res.cloudinary.com/barthkosi/image/upload/explrar-map.avif)
...
![Home screen showing all four widgets](https://res.cloudinary.com/barthkosi/image/upload/explrar-homescreen.avif)

![](https://res.cloudinary.com/barthkosi/image/upload/explrar-homescreen-2.avif)
...
![Document upload bottom sheet](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)

![Document upload screen](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)

![Document upload - closeup](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)

Then there were the badges. 

![Explrar badges](https://res.cloudinary.com/barthkosi/image/upload/explrar-badges.avif)
...
![Three badge screen side by side in the UI](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)
...
![](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)

![](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)

![](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)

![Extra UI and even stuff that was not shipped 4-5 screens](https://res.cloudinary.com/barthkosi/image/upload/placeholder.avif)
...
![](https://res.cloudinary.com/barthkosi/image/upload/explrar-widget-tutorial.avif)
