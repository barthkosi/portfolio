...
export default function Nav() {
  ...
  >
    ...
    <div className="flex flex-row items-center gap-1.5">
      ...
      <div>
      <div className="w-[38px] h-[38px] bg-[var(--background-secondary)] rounded-s"></div>      
      </div>
    </div>
    <div className="absolute top-[64px] relative h3 flex flex-col gap-3 text-[var(--content-primary)]">      
