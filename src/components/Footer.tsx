            ...
            <div className="w-full flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2 label-s text-[var(--content-primary)]">
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <div className="label-xs text-[var(--content-secondary)]">Frames and boxes I made in Figma</div>
                </div>
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <div className="label-xs text-[var(--content-secondary)]">Design Opus</div>
                </div>
