...
export default function HeroSection() {
  ...
  return (
    <section className="relative flex flex-col lg:flex-row px-4 md:px-8 lg:pr-0 lg:gap-8 items-center h-[calc(100vh-64px)] md:h-[calc(100vh-101px)] overflow-hidden">
      {/* Hero Content */}
      <motion.div
      ...
      >
        ...
        <motion.div variants={fadeUpVariant}>
          <p className="body-m max-w-[380px] md:max-w-[640px] lg:max-w-[520px] text-[var(--content-secondary)] text-balance">
            Explore my portfolio of web interactions, engineered solutions, and
            dynamic motion design that aims to inject joy into the digital
            world.
          </p>
        </motion.div>
      ...
      >
        <div
          ...
          style={{
            transform:
              "perspective(500px) rotate(-4deg) rotateX(25deg) skewX(-16deg) skewY(6deg)",
          }}
        >
          {isDesktop ? (
            <>
              ...
              >
                {heroMarquee.slice(0, 5).map((item) => (
                  <Image
                    ...
                    width={320}
                    height={180}
                    className="h-40 md:h-52 w-auto aspect-video object-cover rounded-[var(--radius-lg)] gap-[2px] mx-[1px]"
                  />
                ))}
              </Marquee>
              <Marquee
