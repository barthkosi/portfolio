...
const DEFAULT_MARKDOWN_IMAGE_SIZES =
  "(min-width: 1024px) 640px, calc(100vw - 32px)";
const FULL_MARKDOWN_IMAGE_SIZES =
  "(min-width: 768px) calc(100vw - 64px), calc(100vw - 32px)";
const DEFAULT_ROW_MARKDOWN_IMAGE_SIZES =
  "(min-width: 1024px) 348px, (min-width: 768px) calc(50vw - 40px), calc(100vw - 32px)";
const FULL_ROW_MARKDOWN_IMAGE_SIZES =
  "(min-width: 768px) calc(50vw - 44px), calc(100vw - 32px)";
...
function TableOfContents({ headings }: { headings: HeadingItem[] }) {
  ...
  useEffect(() => {
    ...
    const updateScroll = () => {
      ...
      if (scrollY < headingsTop[0].top && !isAtBottom) {
        ...
        isAtBottom ||
        scrollY >= headingsTop[headingsTop.length - 1].top
      ) {
        ...
        for (let index = 0; index < headingsTop.length - 1; index += 1) {
          ...
          if (scrollY >= current.top && scrollY < next.top) {
            ...
            const progress =
              distance > 0 ? (scrollY - current.top) / distance : 0;
  ...
  return (
    <nav
      ...
      className="relative flex flex-col gap-1 w-[200px] pl-6"
    >
...
export default function PostContent({
  ...
  const markdownImageSizes = isDefaultLayout
    ? DEFAULT_MARKDOWN_IMAGE_SIZES
    : FULL_MARKDOWN_IMAGE_SIZES;
  const rowMarkdownImageSizes = isDefaultLayout
    ? DEFAULT_ROW_MARKDOWN_IMAGE_SIZES
    : FULL_ROW_MARKDOWN_IMAGE_SIZES;
  ...
  const markdownComponents: Components = {
    p: ({ node, children, ...props }) => {
      ...
      return (
        <p
          className="blog-text mb-4 lg:mb-6 text-[var(--content-primary)]"
          {...props}
        >
          {children}
        </p>
    ...
    h1: ({ children, ...props }) => {
      ...
      return (
        <h1
          id={id}
          className="blogh1 mb-4 lg:mb-6 text-[var(--content-primary)]"
          {...props}
        >
          {children}
        </h1>
    ...
    h2: ({ children, ...props }) => {
      ...
      return (
        <h2
          id={id}
          className="blogh2 mb-4 lg:mb-6 text-[var(--content-primary)]"
          {...props}
        >
          {children}
        </h2>
    ...
    h3: ({ children, ...props }) => {
      ...
      return (
        <h3
          id={id}
          className="blogh3 mb-4 lg:mb-6 text-[var(--content-primary)]"
          {...props}
        >
          {children}
        </h3>
    ...
    ul: (props) => (
      <ul
        className="list-disc pl-6 mb-4 lg:mb-6 text-[var(--content-primary)]"
        {...props}
      />
    ),
    ol: (props) => (
      <ol
        className="list-decimal pl-6 mb-4 lg:mb-6 text-[var(--content-primary)]"
        {...props}
      />
    ),
    ...
    blockquote: (props) => (
      <blockquote
        className="border-l-5 border-[var(--border-primary)] pl-3 mb-6 text-[var(--content-tertiary)]"
        {...props}
      />
    ),
    pre: ({ children }) => {
      ...
      if (
        ...
        if (codeElement.props.className === "language-row") {
          ...
          if (matches.length > 0) {
            return (
              <div
                className={`flex flex-col md:flex-row gap-4 lg:gap-6 mb-4 lg:mb-6 ${post.layout !== "full" ? "lg:w-[calc(100%+80px)] lg:max-w-[720px] lg:-ml-[40px]" : ""}`}
              >
    ...
    <article className="flex flex-col">
      ...
      >
        <header className="w-full flex flex-col gap-4 items-start md:items-center">
          <h1 className="text-start md:text-center text-[var(--content-primary)]">
            {post.title}
          </h1>
            ...
            {post.tags && post.tags.length > 0 && (
              <ul className="flex flex-wrap gap-1">
                {post.tags.map((tag) => (
                  <li
                    key={tag}
                    className="px-4 py-2 rounded-xl border-[var(--border-primary)] border-[0.4px]"
                  >
                    {tag}
                  </li>
                ))}
        ...
        <div className="relative w-full">
          <section
            className={`w-full ${post.layout === "full" ? "" : "max-w-[640px]"}`}
          >
        ...
        <nav
          className="w-full flex justify-between items-center pt-4 md:pt-6 border-t border-[var(--border-primary)]"
