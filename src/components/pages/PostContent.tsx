                        ...
                        <motion.div className="fixed inset-0 z-[110] pointer-events-none">
                            ...
                            >
                                <svg width="20" height="20" viewBox="0 0 32 32" fill="none" aria-hidden="true">
                                    <path d="M8 8L24 24" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" fill="none" />
                                    <path d="M8 24L24 8" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" fill="none" />
                                </svg>
                            </motion.button>
                        </motion.div>
                    )}
