      ...
      {!isOpen && (
        <div className="absolute inset-0 -z-10 pointer-events-none">
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, var(--background-primary) 1%, transparent 100%)",
            }}
          />
        </div>
      )}
        ...
        <div className="hidden md:flex label-s flex-row gap-6 text-[var(--content-primary)] items-center">
          {navData.main.map((item) => (
            ...
            >
              <Link
                href={item.href}
                className="hover:text-[var(--content-secondary)]"
              >
                {item.label}
              </Link>
            </motion.div>
            ...
            <div className="flex flex-col gap-1">
              <motion.div
                variants={{
                  ...
                  visible: {
                    opacity: 1,
                    transition: NAV_MENU_VAULT_LABEL_TRANSITION,
                  },
                }}
              >
            ...
            <div className="flex flex-col gap-1">
              <motion.div
                variants={{
                  ...
                  visible: {
                    opacity: 1,
                    transition: NAV_MENU_SOCIAL_LABEL_TRANSITION,
                  },
                }}
              >
                <div className="label-s text-[var(--content-tertiary)]">
