                ...
                <div className='w-full flex flex-col md:flex-row items-start text-left gap-5 p-6 md:p-10'>
                    <div className="w-full flex flex-col gap-3">
                        ...
                        <div className="flex flex-col gap-2 label-s text-[var(--content-primary)] ">
                            ...
                            <div className="flex flex-row gap-2 items-end">
                                <Link href="/work" className="hover:text-[var(--content-secondary)]">Work</Link>
                                <div className="label-xs text-[var(--content-secondary)]">Projects and case studies</div>
                            </div>

                            <div className="flex flex-row gap-2 items-end">
                                <Link href="/explorations" className="hover:text-[var(--content-secondary)]">Explorations</Link>
                                <div className="label-xs text-[var(--content-secondary)]">Personal projects</div>
                            </div>

                            <div className="flex flex-row gap-2 items-end">
                                <Link href="/illustrations" className="hover:text-[var(--content-secondary)]">Illustrations</Link>
                    ...
                    <div className="w-full flex flex-col gap-3">
                        ...
                        <div className="flex flex-col gap-2 label-s text-[var(--content-primary)] ">
                            <div className="flex flex-row gap-2  items-end">
                                <Link href="/archive" className="hover:text-[var(--content-secondary)]">Archive</Link>

                                <div className="label-xs text-[var(--content-secondary)]">Gallery of my work</div>
                            </div>

                            <div className="flex flex-row gap-2 items-end">
                                <Link href="/reading-list" className="hover:text-[var(--content-secondary)]">Reading List</Link>

                                <div className="label-xs text-[var(--content-secondary)]">Books I recommend</div>
                            </div>

                            <div className="flex flex-row gap-2 items-end">
                                <Link href="/writing" className="hover:text-[var(--content-secondary)]">Writing</Link>
